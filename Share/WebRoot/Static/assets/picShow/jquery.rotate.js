...
jQuery.fn.rotate = function (name, maxWidth) {
    ...
    if (document.all) {//ie ...
        ...
        //修改
        var sca = realHeight / this.data('height');
        //
        var ratio = 1;
        ...
        if (step == 1 || step == 0) {
            ...
            context.translate(canvas.width * sca, -costheta * canvas.oImage.height);
        } else if (step == 3) {
            context.translate(-costheta * canvas.oImage.width, this.data('width') * sca);
        } else {
