...
<head>
    ...
    <script>
        $(document).ready(function () {
            //初始化分享列表
            getShareList(null, null, null, '${param.userId}', 0);

            //加载个人简介
            getProfile(${param.userId}, "myProfile");

            //加载个人粉丝
            getFansList(${param.userId}, "myFansList", 1, 6);

            //加载关注列表
            getFollowingList(${param.userId}, "myFollowing", 1, 6);
...
<div class="container">
    <div class="page_title">
        <span id="titie_username">我</span>的所有分享
    </div>
    <div class="row">
